...
export const ROLES = {
    karyawan: {
        ...
        allowedFeatures: ['work', 'career', 'savings', 'loan', 'donate', 'tax', 'finance', 'guide', 'quick-actions'],
    ...
    pebisnis: {
        ...
        allowedFeatures: ['business', 'loan', 'tax', 'savings', 'donate', 'finance', 'guide', 'property'],
    ...
    survivor: {
        ...
        allowedFeatures: ['work', 'career', 'market', 'portfolio', 'invest', 'crypto', 'property', 'business', 'savings', 'loan', 'donate', 'tax', 'finance', 'guide', 'trading-signal', 'quick-actions'],
        hiddenNav: [],
