...
export const ROLES = {
    karyawan: {
        ...
        allowedFeatures: ['work', 'career', 'savings', 'loan', 'donate', 'tax', 'finance', 'guide', 'quick-actions', 'marketplace'],
    ...
    investor: {
        ...
        allowedFeatures: ['market', 'portfolio', 'invest', 'crypto', 'property', 'savings', 'loan', 'finance', 'guide', 'trading-signal', 'quick-actions', 'marketplace'],
    ...
    pebisnis: {
        ...
        allowedFeatures: ['business', 'loan', 'tax', 'savings', 'donate', 'finance', 'guide', 'property', 'marketplace'],
    ...
    survivor: {
        ...
        allowedFeatures: ['work', 'career', 'market', 'portfolio', 'invest', 'crypto', 'property', 'business', 'savings', 'loan', 'donate', 'tax', 'finance', 'guide', 'trading-signal', 'quick-actions', 'marketplace'],
        hiddenNav: [],
